...
public class Appointment {
    ...
    public static String isAppointmentValid(Customer customer, String title, String description, String location,
        ...
        try {
            if (customer == null) {
                errorMsg = errorMsg + rb.getString("customer");
            }
            if (title.length() == 0) {
                errorMsg = errorMsg + rb.getString("title");
            }
            if (description.length() == 0) {
                errorMsg = errorMsg + rb.getString("description");
            }
            if (location.length() == 0) {
                errorMsg = errorMsg + rb.getString("location");
            }
            if (appointmentDate == null || startHour.equals("") || startMinute.equals("") || startAmPm.equals("") ||
                ...
                errorMsg = errorMsg + rb.getString("startEndIncomplete");
            }
            if (Integer.parseInt(startHour) < 1 || Integer.parseInt(startHour) > 12 || Integer.parseInt(endHour) < 1 
                ...
                errorMsg = errorMsg + rb.getString("startEndInvalidTime");
            }
            if ((startAmPm.equals("PM") && endAmPm.equals("AM")) || (startAmPm.equals(endAmPm) && Integer.parseInt(startHour) 
                    != 12 && Integer.parseInt(startHour) > Integer.parseInt(endHour)) || (startAmPm.equals(endAmPm) 
                    && startHour.equals(endHour) && Integer.parseInt(startMinute) > Integer.parseInt(endMinute))) {
                errorMsg = errorMsg + rb.getString("startAfterEnd");
            }
            if ((Integer.parseInt(startHour) < 9 && startAmPm.equals("AM")) || (Integer.parseInt(endHour) < 9 && endAmPm.equals("AM")) ||
                ...
                errorMsg = errorMsg + rb.getString("startEndOutsideHours");
            }
            if (appointmentDate.getDayOfWeek().toString().toUpperCase().equals("SATURDAY") 
                ...
                errorMsg = errorMsg + rb.getString("dateIsWeekend");
            }
        } catch (NumberFormatException e) {
            errorMsg = errorMsg + rb.getString("startEndInt");
